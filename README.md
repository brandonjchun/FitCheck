...
| M2 | Structured profile extraction with normalized skill aliases | Done |
| M3 | Queue skeleton — submit URL, worker transitions, polling UI | Backend done; polling UI pending (M7) |
